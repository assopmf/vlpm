...
export const icones = {
  ...
  horsLigne: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 1l22 22"/><path d="M16.7 13.7a5 5 0 0 1 3.3 1.3M5 12.6a10 10 0 0 1 5.2-2.5M2 8.8a15 15 0 0 1 4.5-2.6M20.6 12.6a10 10 0 0 0-3.1-2M8.5 16.4a5 5 0 0 1 3-1.4M22 8.8a15 15 0 0 0-6.9-3.7"/><path d="M12 20h.01"/></svg>`,
  attente: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3.5 2"/></svg>`,
